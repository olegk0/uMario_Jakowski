...
Beetle::Beetle(int iXPos, int iYPos, bool moveDirection) {
    ...
    this->minionState = 0;
    this->iBlockID = CCore::getMap()->getLevelType() == 0 || CCore::getMap()->getLevelType() == 4 ? 53 : CCore::getMap()->getLevelType() == 1 ? 55
                                                                                                                                              : 57;
...
void Beetle::Draw(CIMG* iIMG) {
    if (minionState != -2) {
        iIMG->Draw((int)fXPos + (int)CCore::getMap()->getXPos(), (int)fYPos, !moveDirection);
    } else {
