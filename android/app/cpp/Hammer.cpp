...
void Hammer::Draw(CIMG* iIMG) {
    if (minionState != -2) {
        iIMG->Draw((int)fXPos + (int)CCore::getMap()->getXPos() - 4, (int)fYPos - 4, false);
    } else {
        iIMG->DrawVert((int)fXPos + (int)CCore::getMap()->getXPos() - 4, (int)fYPos - 4);
    }
}
