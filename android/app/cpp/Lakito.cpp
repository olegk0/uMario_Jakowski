...
void Lakito::Draw(CIMG* iIMG) {
    if (minionState != -2) {
        iIMG->Draw((int)fXPos + (int)CCore::getMap()->getXPos(), (int)fYPos - 16, !moveDirection);
    } else {
        iIMG->DrawVert((int)fXPos + (int)CCore::getMap()->getXPos(), (int)fYPos - 16);
    }
}
